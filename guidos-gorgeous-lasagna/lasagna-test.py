#Instructions
#You're going to write some code to 
...
#Define the EXPECTED_BAKE_TIME constant that represents 
...
# Complete the bake_time_remaining() function that takes 
# the actual minutes the lasagna has been in the oven 
# as an argument and returns how many minutes 
# the lasagna still needs to bake based on the EXPECTED_BAKE_TIME constant.

#>>> bake_time_remaining(30)
#10
#3. Calculate preparation time in minutes
# Define the preparation_time_in_minutes() 
# function that takes the number_of_layers 
# you want to add to the lasagna as an argument
